function movingTarget(input) {
    ...
    while (currentLine != "End") {
        ...
        let power = Number(currentInput[2]);
        ...
        switch (command) {
            ...
            case 'Strike':
                let radius = power;
                //   let firstItem =  targets.slice(0,index - radius);
                //   let secondItem = targets.slice(0, index + radius);
                //   targets = firstItem.concat(secondItem);
